    ...
    <main className="container mx-auto px-4 py-8 md:py-12 max-w-6xl text-zinc-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 items-start">
        ...
        <div className="flex flex-col gap-8">
          ...
          {/* Metadata Grid (Titles, Airing, Status, Genres) */}
          <section className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 py-6 border-y border-zinc-800/60 text-sm">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-zinc-500 font-medium">Japanese Title</span>
              <span className="text-zinc-200">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-zinc-200">{anime.aired || "Unknown"}</span>
            </div>
            <div className="flex flex-col gap-1">
